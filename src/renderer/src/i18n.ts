...
"app.agentDeleteTitle": "删除 Agent",
  ...
  "settings.firstMessagePrefix": "首条消息前缀",
  "settings.firstMessagePrefixDesc": "使用此 provider 开启新会话时，首条普通消息自动携带此前缀；同一 provider 下模型共享配置",
  "settings.firstMessagePrefixPlaceholder": "例如：请先阅读项目 README，理解项目架构后再开始工作",
  "settings.firstMessagePrefixHint": "仅对新建会话有效，已有消息的会话不受影响。不适用于 shell 命令和斜杠命令。",
  ...
  "piUpdate.ariaLabel": "pi 更新提醒",
  "piUpdate.commandCopied": "已复制命令：{command}",
  "piUpdate.copyCoreCommand": "复制 pi update",
  "piUpdate.copyPackagesCommand": "复制 pi update --extensions",
  "piUpdate.coreDescription": "当前 pi v{current}，最新 v{latest}。复制命令后可在终端运行更新。",
  "piUpdate.coreTitle": "pi CLI 有新版本",
  "piUpdate.openChangelog": "打开 changelog",
  "piUpdate.packageVersion": "v{current} → v{latest}",
  "piUpdate.packagesDescription": "已安装的 pi 扩展包有可用更新。",
  "piUpdate.packagesTitle": "pi 扩展包有更新",
  ...
  "update.skipCurrentVersion": "跳过当前版本",
  "update.skippedNotice": "已跳过 v{version}，后续更高版本仍会提醒。",
...
"app.agentDeleteTitle": "Delete Agent",
  ...
  "settings.firstMessagePrefix": "First Message Prefix",
  "settings.firstMessagePrefixDesc": "Content automatically prepended to the first message when using this provider; all models under the same provider share this setting",
  "settings.firstMessagePrefixPlaceholder": "e.g. Please review the project README and understand the architecture first",
  "settings.firstMessagePrefixHint": "Only applies to new sessions. Existing conversations are not affected. Not applied to shell commands or slash commands.",
  ...
  "piUpdate.ariaLabel": "pi update notices",
  "piUpdate.commandCopied": "Copied command: {command}",
  "piUpdate.copyCoreCommand": "Copy pi update",
  "piUpdate.copyPackagesCommand": "Copy pi update --extensions",
  "piUpdate.coreDescription": "Current pi v{current}; latest v{latest}. Copy the command and run it in a terminal to update.",
  "piUpdate.coreTitle": "pi CLI update available",
  "piUpdate.openChangelog": "Open changelog",
  "piUpdate.packageVersion": "v{current} → v{latest}",
  "piUpdate.packagesDescription": "Installed pi extension packages have available updates.",
  "piUpdate.packagesTitle": "pi package updates available",
  ...
  "update.skipCurrentVersion": "Skip this version",
  "update.skippedNotice": "Skipped v{version}. Newer versions will still be shown.",
